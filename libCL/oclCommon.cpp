...
void oclInit(char* iRootPath)
{
    ...
    clErrors[-CL_INVALID_IMAGE_DESCRIPTOR] = "CL_INVALID_IMAGE_DESCRIPTOR";
    clErrors[-CL_INVALID_COMPILER_OPTIONS] = "CL_INVALID_COMPILER_OPTIONS";
    clErrors[-CL_INVALID_LINKER_OPTIONS] = "CL_INVALID_LINKER_OPTIONS";
    clErrors[-CL_INVALID_DEVICE_PARTITION_COUNT] = "CL_INVALID_DEVICE_PARTITION_COUNT";
}
